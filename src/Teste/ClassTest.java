...
public class ClassTest {
	...
	public static void main(String[] args) {
		System.out.println("Gerador de senha: "+PasswordUtilities.KeyGenerator(0, false, false, false, false));
		System.out.println("Aplicar % de desconto em um valor: "+MatUtilities.ApplyDiscValor(0, 30));
		...
		System.out.println("Diferença em % entre dois valores: "+String.format("%.2f", MatUtilities.DeltaVariation(10, 87)));
		System.out.println("Qual o valor original? "+String.format("%.2f", MatUtilities.OriginalValue(1568, 35)));
		System.out.println("Regra de três: "+String.format("%.2f", MatUtilities.ThreeRule(1200, 1300, 100)));
	}
